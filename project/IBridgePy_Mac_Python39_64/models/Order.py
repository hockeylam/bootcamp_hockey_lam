...
class IbridgePyOrder(object):
    ...
    def sid(self):  # Quantopian
        raise NotImplementedError('sid is not implemented yet.')

    @property
    def limit_reached(self):  # Quantopian, return bool
        raise NotImplementedError('limit_reached is not implemented yet.')

    @property
    def stop_reached(self):  # Quantopian, return bool
        raise NotImplementedError('stop_reached is not implemented yet.')

    @property
    def filledTime(self):  # Quantopian, the time when this order is filled.
        if self.execDetailsRecord is not None:
            return self.execDetailsRecord.execution.get('time')
        else:
            return None
    ...
    def stop(self):  # Quantopian, stop price
        if self.openOrderRecord is not None:
            ...
            return self.openOrderRecord.order.get('auxPrice')
        else:
            return None
    ...
    def limit(self):  # Quantopian, limit price
        if self.openOrderRecord is not None:
            return self.openOrderRecord.order.get('lmtPrice')
        else:
            return self.requestedOrder.get('lmtPrice')

    @property
    def commission(self):  # Quantopian, commission
        if self.openOrderRecord is not None:
            return self.openOrderRecord.orderState.get('commission')
        else:
            return None
    ...
    def parentOrderId(self):  # IbridgePyOrder
        if self.openOrderRecord is not None:
            return self.openOrderRecord.order.get('parentId')
        else:
            return None
