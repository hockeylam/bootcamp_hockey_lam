...
class ActiveRequestBatch(object):
    ...
    def _add(self, aRequest):
        ...
        :param aRequest: BrokerClientDef.Request
        :return: None
        """
        reqId = self.nextReqId.use_next_id()
...
class Request(object):
    def __init__(self, reqType, followUp=ReqAttr.FollowUp.FOLLOW_UP, status=ReqAttr.Status.CREATED,
        ...
        self.follow_up_on = None  # the name of the callback function that this request should follow up. For example, get_option_info should follow up on tickOptionComputation instead of tickPrice
...
class ReqMktData(Request):
    def __init__(self, security, tickTypeClientAsked=None, genericTickList='', snapshot=False, followUp=True, waitForFeedbackInSeconds=10, follow_up_on='tickPrice'):
        ...
        self.follow_up_on = follow_up_on
