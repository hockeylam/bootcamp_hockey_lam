...
class OrderStyle(object):
    ...
    def __str__(self):
        ...
        if self.orderType == 'MKT':
            ...
            exit(f'EXIT, cannot handle orderType={self.orderType}')
...
class MarketOnOpenOrder(OrderStyle):
    def __init__(self):
        OrderStyle.__init__(self, orderType='MKT', tif='OPG')
