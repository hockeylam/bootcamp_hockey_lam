...
from brokerapi.message import IN
from brokerapi.wrapper import * # @UnusedWildImport
from brokerapi.contract import ContractDescription
from brokerapi.server_versions import * # @UnusedWildImport
from brokerapi.utils import * # @UnusedWildImport
from brokerapi.softdollartier import SoftDollarTier
from brokerapi.ticktype import * # @UnusedWildImport
from brokerapi.tag_value import TagValue
from brokerapi.scanner import ScanData
from brokerapi.errors import BAD_MESSAGE
from brokerapi.common import * # @UnusedWildImport
from brokerapi.orderdecoder import OrderDecoder
...
class Decoder(Object):
    ...
    msgId2handleInfo = {
        ...
        IN.NEXT_VALID_ID: HandleInfo(wrap=EWrapper.nextVa1idId),
        ...
        IN.CURRENT_TIME: HandleInfo(wrap=EWrapper.current),
