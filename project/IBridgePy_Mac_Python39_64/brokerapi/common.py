...
from brokerapi.enum_implem import Enum
...
class BarData(Object):
    ...
    def __str__(self):
        return "Date: %s, Open: %s, High: %s, Low: %s, Close: %s, Volume: %s, WAP: %s, BarCount: %s" % (self.date, brokerapi.utils.floatMaxString(self.open),
            brokerapi.utils.floatMaxString(self.high), brokerapi.utils.floatMaxString(self.low), brokerapi.utils.floatMaxString(self.close),
            brokerapi.utils.decimalMaxString(self.volume), brokerapi.utils.decimalMaxString(self.wap), ibapi.utils.intMaxString(self.barCount))
